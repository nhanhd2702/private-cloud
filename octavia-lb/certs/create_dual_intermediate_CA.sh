...
openssl genpkey -algorithm RSA -out private/ca.key.pem -aes256 -pkeyopt rsa_keygen_bits:4096 -pass pass:not-secure-passphrase
chmod 400 private/ca.key.pem

# Create the client CA root certificate
openssl req -config ../../openssl.cnf -key private/ca.key.pem -new -x509 -sha256 -extensions v3_ca -days 7300 -out certs/ca.cert.pem -subj "/C=VN/ST=Southeast/L=HoChiMinh/O=Honeynet/OU=Octavia/CN=ClientRootCA" -passin pass:not-secure-passphrase
...
openssl genpkey -algorithm RSA -out intermediate_ca/private/intermediate.ca.key.pem -aes256 -pkeyopt rsa_keygen_bits:4096 -pass pass:not-secure-passphrase
chmod 400 intermediate_ca/private/intermediate.ca.key.pem

# Create the client intermediate CA certificate signing request
openssl req -config ../../openssl.cnf -key intermediate_ca/private/intermediate.ca.key.pem -new -sha256 -out intermediate_ca/client_intermediate.csr -subj "/C=VN/ST=Southeast/L=HoChiMinh/O=Honeynet/OU=Octavia/CN=ClientIntermediateCA" -passin pass:not-secure-passphrase
...
openssl genpkey -algorithm RSA -out intermediate_ca/private/controller.key.pem -aes256 -pkeyopt rsa_keygen_bits:4096 -pass pass:not-secure-passphrase
chmod 400 intermediate_ca/private/controller.key.pem

# Create the client controller certificate signing request
openssl req -config ../../openssl.cnf -key intermediate_ca/private/controller.key.pem -new -sha256 -out intermediate_ca/controller.csr -subj "/C=VN/ST=Southeast/L=HoChiMinh/O=Honeynet/OU=Octavia/CN=OctaviaController" -passin pass:not-secure-passphrase
...
openssl req -config ../../openssl.cnf -key private/ca.key.pem -new -x509 -sha256 -extensions v3_ca -days 7300 -out certs/ca.cert.pem -subj "/C=VN/ST=Southeast/L=HoChiMinh/O=Honeynet/OU=Octavia/CN=ServerRootCA" -passin pass:not-secure-passphrase
...
openssl req -config ../../openssl.cnf -key intermediate_ca/private/intermediate.ca.key.pem -new -sha256 -out intermediate_ca/server_intermediate.csr -subj "/C=VN/ST=Southeast/L=HoChiMinh/O=Honeynet/OU=Octavia/CN=ServerIntermediateCA" -passin pass:not-secure-passphrase
